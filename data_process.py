...
from posture import FullBodyPoseEmbedder
...
class BootstrapHelper(object):
    ...
    def dump_for_the_app(self):
        pose_samples_folder = self._csvs_out_folder
        pose_samples_csv_path = self._csvs_out_folder + '/model_out.csv'
        file_extension = 'csv'
        file_separator = ','
...
if __name__ == '__main__':
    # 指定训练集路径
    bootstrap_images_in_folder = 'dataset'
    #
    # # Output folders for bootstrapped images and CSVs.
    bootstrap_images_out_folder = "C:/Users/a/PycharmProjects/ai-count/proceed_data"
    bootstrap_csvs_out_folder = 'C:/Users/a/PycharmProjects/ai-count/proceed_csv'
    ...
    # 生成csv
    bootstrap_helper.dump_for_the_app()
